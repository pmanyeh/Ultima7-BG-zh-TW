...
labelFunc06F6_0646:
	...
	message("「很久以前，即使以我的時間計算也是如此，我的人民在試圖征服這個領域時，被一個強大的種族擊敗了。這個種族早在你的君主，不列顛王（Lord British）到來之前就住在這裡了。我的人民被擊敗了，他們預期會面臨死亡，但這些偉大而強大的存在並不是毀滅者。然而，他們也不希望我的同類進一步造成破壞。所以他們編織了超出我種族認知的魔法，將我們與這個領域的居民綁定在一起。你們自己的人只是利用現有的魔法來奴役我們，有時甚至不知道這是如何實現的。」");
	say();
	UI_remove_answer("束縛");
labelFunc06F6_0659:
