...
labelFunc04EF_01A9:
	...
	message("「這個礦坑的工頭 Mikos 告訴我們要一直戴著安全帽。這非常重要。我們倆甚至送了一頂礦工安全帽給 Lord British 。一個穿得像聖者的滑稽男人告訴我們， Lord British 曾經被掉落的物體砸到頭——兩次！所以我們寄了一頂安全帽給他。」*");
	say();
	UI_show_npc_face(0xFF0D, 0x0000);
	message("看來 Malloy 再也無法忍受被排除在對話之外了。「送安全帽給 Lord British 是『我』的主意，」他驕傲地說。「雖然我們還沒收到他的回覆，但我確定他會找到方法感謝我們的。」 Malloy 的安全帽掉了下來，他在那裡站了很久才恢復鎮定把它撿起來。*");
	say();
	UI_remove_npc_face(0xFF0D);
	UI_show_npc_face(0xFF11, 0x0000);
