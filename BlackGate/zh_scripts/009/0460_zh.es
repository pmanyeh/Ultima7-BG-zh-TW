...
labelFunc0460_008B:
	...
	message("「我的人民在這個世界上幾乎已經完全滅絕了。既然我是他們的領袖，我將他們的福祉視為我唯一的責任。很快我就會決定我們是否要離開 Minoc。」");
	say();
	UI_remove_answer("吉普賽人");
	UI_add_answer(["滅絕", "Minoc"]);
labelFunc0460_00AB:
	case "滅絕" attend labelFunc0460_00BE:
	message("「我們吉普賽人是為了流浪而生的民族。但歡迎我們的地方越來越少了。我們是自古 Sosaria 時代以來一直困擾我們族群的古老仇恨的受害者。」");
	say();
	UI_remove_answer("滅絕");
labelFunc0460_00BE:
	case "Minoc" attend labelFunc0460_00DE:
	message("「我們的人民來到這裡，因為我們以為我們會被接受。很長一段時間以來，似乎的確如此。但在這些野蠻的謀殺案發生之後，看起來是我們再次流浪的時候了。」");
	say();
...
labelFunc0460_0114:
	...
	message("「有些人認為我的兄弟 Frederico 是個嚴厲的人，但我們這些認識他的人可以看出，他只是受到統治所有吉普賽人的同樣的驕傲和熱情所驅使。」");
	say();
...
labelFunc0460_013A:
	...
	message("「他是 Frederico 和 Tania 的兒子。他離開我們去了解更多關於友誼會的事。當然，他對發生的事情感到自責……」");
	say();
