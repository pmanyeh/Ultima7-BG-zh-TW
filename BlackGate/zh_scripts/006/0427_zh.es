...
void Func0427 object#(0x427) ()
{
	...
	message("Neno 正忙著和 The Avatars 樂團一起表演，現在無法說話。*");
	say();
	abort;
	goto labelFunc0427_003F;
labelFunc0427_003A:
	message("「我必須趕去藍野豬酒館 (Blue Boar) 表演！ The Avatars 樂團今晚要演出！」*");
	say();
	abort;
labelFunc0427_003F:
...
labelFunc0427_0094:
	...
	message("「成為一名吟遊詩人是莫大的榮譽。你帶給其他人快樂，同時也滿足了自己內心的創作慾望。這真的很神奇。我是從我在 The Avatars 樂團演奏的經驗中知道這點的。」");
	say();
...
labelFunc0427_00C8:
	...
	UI_remove_answer("娛樂");
labelFunc0427_00DB:
	case "The Avatars 樂團" attend labelFunc0427_00EE:
