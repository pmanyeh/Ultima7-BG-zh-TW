...
labelFunc0423_014A:
	...
	message("「我相信大多數疾病是由微小的生物引起的。我們無法用肉眼看到這些東西。然而，我正在致力於開發一種儀器，可以 -看到- 這些生物。我相信總有一天，治療將完全不依賴魔法，而是依賴某種形式的治療，使人不容易受到這些生物的感染。由於這些動物是生物，我稱這種理論上的治療為『抗生素（antibiotics）』。你覺得呢，聖者？我走在正確的道路上嗎？」");
	say();
	UI_remove_answer("理論");
	var0003 = Func090A();
