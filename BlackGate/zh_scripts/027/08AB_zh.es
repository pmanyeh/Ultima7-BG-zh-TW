...
void Func08AB 0x8AB ()
{
	...
	say();
	message("「感謝各位 Trinsic 的友誼會成員今晚參加我們的會議。~~我想你們一定都很清楚我們城裡所發生的罪行。現在是哀悼那些我們失去之人的時刻。我們將永遠銘記我們的鐵匠 Christopher，他既是我們鎮上寶貴的公民，也是一位摯友。Inamo 是一位和藹可親且勤奮的石像鬼。正如他們的死亡所顯示的，Britannia 比以往任何時候都更需要友誼會。」");
	say();
	...
	say();
	message("「我們必須將這種理念傳播給每一個能聽到的人。因為除了我們友誼會之外，還有誰能將分裂、猜忌且不配的 Britannia 從悲慘的境地中提升起來呢？」");
	say();
...
labelFunc08AB_00BF:
	...
	message("「身為友誼會成員，我覺得我正在為 Britannia 做一些好事。」*");
	say();
