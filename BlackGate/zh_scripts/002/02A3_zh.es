...
labelFunc02A3_003E:
	...
	var0002 = UI_execute_usecode_array(var0001, [(byte)0x23, (byte)0x52, "@我會說的！@"]);
	var0002 = UI_delayed_execute_usecode_array(var0001, [(byte)0x23, (byte)0x52, "@寶藏在...@"], 0x0010);
	var0002 = UI_delayed_execute_usecode_array(var0001, [(byte)0x23, (byte)0x52, "@南緯 169 度@"], 0x0020);
	var0002 = UI_delayed_execute_usecode_array(var0001, [(byte)0x23, (byte)0x52, "@東經 28 度@"], 0x0030);
labelFunc02A3_00B3:
...
labelFunc02A3_00E6:
	...
	var0002 = UI_execute_usecode_array(item, [(byte)0x23, (byte)0x52, "@ Polly 想要餅乾嗎？@"]);
labelFunc02A3_0102:
	if (!((var0003 == 0x0003) || (var0003 == 0x0004))) goto labelFunc02A3_013B;
	var0002 = UI_execute_usecode_array(item, [(byte)0x23, (byte)0x52, "@我知道...@"]);
	var0002 = UI_delayed_execute_usecode_array(item, [(byte)0x23, (byte)0x52, "@寶藏就在那裡！@"], 0x0010);
labelFunc02A3_013B:
	if (!(var0003 == 0x0005)) goto labelFunc02A3_0157;
	var0002 = UI_execute_usecode_array(item, [(byte)0x23, (byte)0x52, "@給我餅乾！@"]);
labelFunc02A3_0157:
	...
	var0002 = UI_delayed_execute_usecode_array(item, [(byte)0x23, (byte)0x52, "@醜八怪！@"], 0x0020);
