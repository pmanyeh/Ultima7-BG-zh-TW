...
labelFunc0492_0187:
	...
	message(var0001);
	message("？」你看到他眼中有著認得你的神情，但隨後就消失了。~~「原諒我。」他搖搖頭，然後笑了笑。「我是 Quenton，但現在只是個幽影了…」");
	say();
	gflags[0x01CB] = true;
...
labelFunc0492_021E:
	...
	say();
	message("「然後，有一天，我的妻子被從我身邊帶走了。我不知道去哪裡，也不知道被誰帶走，只知道他們是邪惡的人。不久之後，我可愛的 Marney 傷心欲絕，我擔心她的健康。我無法放下捕魚的工作來照顧她，但我需要金幣。所以我跟一個不好惹的男人做了一筆交易。這就是我毀滅的開始，因為當我無法償還他的貸款時，他在某個晚上來找我並殺了我。我沒有機會還手或求救。」他陷入沉默。~~「然而……那皆是發生在將整座島嶼……付之一炬並化為死者之地的大火之前，極其遙遠的事了。」");
	say();
	UI_remove_answer("幽影");
...
labelFunc0492_0242:
	...
	message(var0001);
	message("。~~「他談到他女兒時，偶爾會像那樣失去控制。不過我相信你能理解。」*");
	say();
...
labelFunc0492_039E:
	...
	message("你向他解釋，需要一個靈魂自願進入靈魂之井，以帶來它的毀滅。 Quenton 考慮了一會兒，然後回答說：「請理解，");
	message(var0001);
