...
void Func0625 object#(0x625) ()
{
	...
	message("你看到一個憤怒的守衛。~~多年的教導讓他產生了過度發展的紀律感~~以及對維持秩序的狂熱奉獻。現在，他所有的熱情都指向了你。~~「在 Trinsic 城牆的聖所內，絕不容忍這種行為。~~你的紅色披風和金色的捲髮只表明你是一個邪惡的冒名頂替者，而不是真正的聖者。~~受死吧！」");
	say();
...
labelFunc0625_007B:
	...
	message("你看到一個憤怒的守衛。「立刻停止！~~你想避免漫長審判帶來的不快嗎？」");
	say();
	var0005 = Func090A();
...
labelFunc0625_00D0:
	message("守衛對你微不足道的出價不為所動。「再多一點怎麼樣？我們的監獄裡關了一些討人厭的傢伙。」");
	say();
...
labelFunc0625_019C:
	goto labelFunc0625_01DB;
labelFunc0625_019F:
	message("你看到一個憤怒的守衛。「立刻停止！~~你會乖乖跟我走嗎？」");
	say();
	if (!Func090A()) goto labelFunc0625_01DB;
	message("「很好。你將被關在監獄裡，直到我們認為適合釋放你為止。」");
	say();
	UI_remove_npc_face(0xFEFE);
