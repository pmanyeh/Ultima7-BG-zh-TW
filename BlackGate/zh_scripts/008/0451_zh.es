...
labelFunc0451_00E0:
	...
	message("「這對友誼會來說的確是個偉大的一天！去 Britain 找 Batlin 。他是我們的創始人。讓聖者加入友誼會這份莫大的榮耀，理應只保留給他。」");
	say();
...
labelFunc0451_0115:
	...
	message("「我現在想起 Batlin 給我的一條信息。我一直在等你。你被派來運送我們的包裹。你現在可以把它交出來了。」");
	say();
	UI_add_answer("交貨");
labelFunc0451_0133:
	if (!(var0000 && (!gflags[0x0006]))) goto labelFunc0451_0142;
	message("Elynor 注意到你的護身符。「我認為你還不應該戴著這個護身符。你還沒有被正式引入友誼會！恐怕我必須通知 Batlin 你的謊言！」");
	say();
labelFunc0451_0142:
...
labelFunc0451_0187:
	message("「我們的城市不像 Britain 那麼偉大，但作為商業中心和礦產而廣為人知。 Owen 遺產帶來的小小尷尬會隨著時間消退。」");
	say();
	UI_add_answer("Owen");
labelFunc0451_0192:
...
labelFunc0451_024A:
	...
	message("「你很清楚你被指示要原封不動地送達包裹。身為友誼會的成員，你明白我們必須配得上我們追求的回報。既然你辜負了 Batlin 的信任，任何報酬都被沒收了。他將會被告知這個輕率的舉動，而他不會高興的。」~~她從你手中接過盒子。");
	say();
...
labelFunc0451_02CA:
	...
	message(var0002);
	message("，盒子被洗劫一空了！」~~她上下打量著你。「 Batlin 將會被告知這項……進展。」");
	say();
	gflags[0x011E] = true;
	Func0911(0x01F4);
labelFunc0451_02DE:
...
labelFunc0451_032E:
	...
	message("她檢查了盒子內部。~~「啊，很好。至少裡面的東西還完好無損。有罪的人只是他自己好奇心的受害者，而不是真正的小偷。」~~她上下打量著你。「你很可能還是會學著成為我們傑出會員中相稱的一員。我們等著看。」~~她哼了一聲。「當然，這將會被報告給 Batlin 。」");
	say();
	UI_remove_item(var0009);
	gflags[0x0102] = true;
	Func0911(0x01F4);
...
labelFunc0451_0356:
	message("窺視裡面，她勃然大怒。「看起來你被搶了。顯然，既然你辜負了 Batlin 託付給你的責任，你將不會收到任何報酬。」~~「 Batlin 將會被告知這個輕率的舉動。」");
	say();
	gflags[0x011E] = true;
	Func0911(0x01F4);
labelFunc0451_0364:
