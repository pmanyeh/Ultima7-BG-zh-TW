...
labelFunc08BA_0073:
	...
	message("「我看見如果你想了解更多關於友誼會的事並發現他們的真實本質，你就必須加入他們。");
	say();
	goto labelFunc08BA_0089;
labelFunc08BA_0085:
	message("「既然你已經是友誼會的成員，你遲早會更了解他們並發現他們的真實本質。");
	say();
labelFunc08BA_0089:
	message("「不是很清楚……啊，對了……有一種新的邪惡正在威脅 Britannia。我看見你將來必須與它交手。");
	say();
	message("「水晶球告訴我，世界的以太——即控制魔法的物質——已經受到這種新的邪惡存在所影響。");
	say();
	message("「我進一步看見，這種邪惡存在在不久後的某個事件中會獲得更強大的力量。這個事件與行星有關。去 Moonglow 的天文台找一個人，了解更多關於這件事的資訊。我看見他有一個對你非常有用的裝置。儘快去找他，因為這個事件即將來臨。」");
	say();
	message("「這是什麼？我看見……我看見……你在尋找一個『帶著鉤子的人』。他不是你真正的對手，但找到他是完成你終極任務的必要條件。");
	say();
	message("「等等！我看見你必須去覲見 Time Lord。他有麻煩了，雖然我看不出是什麼麻煩。Time Lord 知道許多關於這個新邪惡的事，所以千萬不要錯過去找他。");
	say();
	message("「要找到 Time Lord，你必須先見到住在 Yew 森林裡的 Visps。他們是你聯繫他最好的途徑。Empath Abbey 的僧侶也許知道如何聯繫這些 Visps。");
	say();
