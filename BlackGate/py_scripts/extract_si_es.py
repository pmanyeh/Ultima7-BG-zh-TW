...
# ================= 設定區 =================
# 您的全量 .uc 檔案位置
uc_full_path = r"d:\git\exult-master\tools\ucxt\output\bg_usecode_full.uc"

# ucxt 執行檔位置 (根據您的環境可修改)
ucxt_exe = r"C:\Program Files\Exult\Tools\ucxt.exe"

# USECODE 原始檔路徑 (供 ucxt 讀取)
usecode_source = r"D:\U7_project\Ultima 7\STATIC\USECODE"

# 輸出目錄
output_dir = r"d:\git\exult-master\tools\ucxt\output\bg_translation\es_scripts"
